...
export const uiCopy = {
  en: {
    ...
    hero: {
      ...
      profileCode: "PROFESSIONAL PROFILE",
      focus: "Core focus",
    },
    sections: {
      about: "Professional snapshot",
      aboutTitle: "A focused bridge between business context and software execution.",
      summary: "Career summary",
      summaryTitle: "Business context.\nStructured execution.",
      brand: "Personal brand",
      brandTitle: "A clear bridge between business, data and delivery.",
      brandDescription: "Professional positioning for recruiters, partners and customers who need to understand how I create value.",
      experience: "Experience",
      experienceTitle: "Professional experience with delivery context.",
      experienceDescription: "A concise view of roles, responsibilities and delivery ownership. The resume keeps the full detail; the portfolio highlights the signal.",
      selectedWork: "Selected work",
      projectsTitle: "Selected work that proves practical delivery capability.",
      projectsDescription: "Featured projects are presented as recruiter-friendly mini case studies: context, role, contribution and impact.",
      skills: "Expertise",
      skillsTitle: "Expertise across business, product and technology.",
      skillsDescription: "Grouped capabilities that help recruiters scan strengths without reading a long skill wall.",
      ...
      process: "Process",
      processTitle: "How I turn unclear work into usable delivery.",
      processDescription: "A compact working process for understanding problems, structuring requirements, aligning people and moving solutions into production.",
      blog: "Insights",
      blogTitle: "Insights on delivery, systems and practical work.",
      blogDescription: "Professional notes that show how I think about implementation, business analysis, data validation and product decisions.",
      contact: "Contact",
    },
    projects: {
    ...
    blog: {
      ...
      allPostsTitle: "Insights",
      allPostsDescription: "Selected insights on software implementation, project delivery, business analysis and practical product work.",
  ...
  vi: {
    ...
    hero: {
      ...
      profileCode: "HỒ SƠ CHUYÊN NGHIỆP",
      focus: "Trọng tâm",
    },
    sections: {
      about: "Chân dung nghề nghiệp",
      aboutTitle: "Cầu nối rõ ràng giữa bối cảnh nghiệp vụ và triển khai phần mềm.",
      ...
      brandDescription: "Định vị nghề nghiệp để nhà tuyển dụng, đối tác và khách hàng hiểu cách tôi tạo giá trị.",
      experience: "Kinh nghiệm",
      experienceTitle: "Kinh nghiệm nghề nghiệp gắn với bối cảnh triển khai.",
      experienceDescription: "Tóm tắt vai trò, trách nhiệm và năng lực điều phối triển khai. CV sẽ giữ phần chi tiết đầy đủ; portfolio chỉ hiển thị tín hiệu quan trọng.",
      selectedWork: "Dự án tiêu biểu",
      projectsTitle: "Dự án tiêu biểu chứng minh năng lực triển khai thực tế.",
      projectsDescription: "Các dự án nổi bật được trình bày như mini case study dành cho nhà tuyển dụng: bối cảnh, vai trò, đóng góp và tác động.",
      skills: "Chuyên môn",
      skillsTitle: "Chuyên môn trải rộng giữa nghiệp vụ, sản phẩm và công nghệ.",
      skillsDescription: "Các nhóm năng lực giúp nhà tuyển dụng scan nhanh điểm mạnh mà không phải đọc một bức tường kỹ năng.",
      ...
      process: "Quy trình",
      processTitle: "Cách tôi biến công việc chưa rõ thành giải pháp có thể bàn giao.",
      processDescription: "Quy trình làm việc gọn để hiểu vấn đề, cấu trúc yêu cầu, đồng bộ các bên và đưa giải pháp vào vận hành.",
      blog: "Insights",
      blogTitle: "Insights về triển khai, hệ thống và công việc thực tế.",
      blogDescription: "Các ghi chú chuyên môn thể hiện cách tôi suy nghĩ về triển khai phần mềm, phân tích nghiệp vụ, kiểm tra dữ liệu và quyết định sản phẩm.",
      contact: "Liên hệ",
    },
    projects: {
    ...
    blog: {
      ...
      allPostsTitle: "Insights",
      allPostsDescription: "Các insight về triển khai phần mềm, quản lý dự án, phân tích nghiệp vụ và tư duy sản phẩm thực tế.",
